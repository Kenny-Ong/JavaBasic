...
public class Task3 {
	...
	public static void main(String[] args) {
		  ...
		  * user enters money, accumulate the amount and tell 
		  * the user how much is left to pay off. If user give
		more money program should return a change. Whenever 
		user done with payments program should say "Thank you 
		for shopping!"*/
